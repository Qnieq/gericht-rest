...
const HeroSection: React.FC<{type: string}> = (props) => {
            ...
            <div className={styles.content}>
                ...
                <div className={styles.link_box}>
                    ...
                    {words.map((word, index) => {
                        ...
                        return (
                            <>
                                <svg key={index} width="8" height="13" viewBox="0 0 8 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <Link key={index} to={`/Home/${linkPath}`} className={styles.link}>{word}</Link>
                            </>
                        );
                    })}
                </div>
