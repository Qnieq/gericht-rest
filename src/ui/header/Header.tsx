...
import AuthInterface from "../auth_interface/AuthInterface";
...
const Header: React.FC<{ color: string }> = (props) => {
    ...
    const { logoutLogin, logoutReg } = useActions()
            ...
            <div className={styles.container} style={{ background: props.color }}>
                <div className={styles.content}>
                    ...
                    <div className={styles.other}>
                        {auth ?
                            <button onClick={() => (logoutReg(), logoutLogin())} className={styles.log_reg}>Logout</button>
                            :
                            <button onClick={() => {
                                setActiveReg(!activeReg)
