...
import styles from "./BlogDetailBgElem.module.scss"

const BlogDetailBgElem = () => {
    ...
    return (
        <div className={styles.container}>
            <div className={styles.arrow} style={{height: height - 1000}}>
...
export default BlogDetailBgElem;